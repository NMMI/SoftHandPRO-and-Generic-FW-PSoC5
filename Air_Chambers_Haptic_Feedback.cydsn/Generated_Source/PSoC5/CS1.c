...
*
* \funcusage
*  \snippet CS1_SUT.c usage_CS1_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet CS1_SUT.c usage_CS1_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet CS1_SUT.c usage_CS1_Read  
*******************************************************************************/
uint8 CS1_Read(void)
{
...
* preferred CS1_Read() API because the 
* CS1_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet CS1_SUT.c usage_CS1_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: CS1_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use CS1_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - CS1_0_INTR       (First pin in the list)
    *  - CS1_1_INTR       (Second pin in the list)
    *  - ...
    *  - CS1_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet CS1_SUT.c usage_CS1_SetInterruptMode
    *******************************************************************************/
    void CS1_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & CS1_0_INTR) != 0u) 
		{ 
			 CS1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet CS1_SUT.c usage_CS1_ClearInterrupt
    *******************************************************************************/
