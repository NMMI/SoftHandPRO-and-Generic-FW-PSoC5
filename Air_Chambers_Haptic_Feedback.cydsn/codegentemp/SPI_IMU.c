...
uint8 SPI_IMU_initVar = 0u;

volatile uint8 SPI_IMU_swStatusTx;
volatile uint8 SPI_IMU_swStatusRx;


/*******************************************************************************
* Function Name: SPI_IMU_Init
********************************************************************************
*
* Summary:
...
void SPI_IMU_Init(void) 
{
    ...
    SPI_IMU_COUNTER_PERIOD_REG = SPI_IMU_BITCTR_INIT;

    /* Init TX ISR  */
    #if(0u != SPI_IMU_INTERNAL_TX_INT_ENABLED)
    ...
    /* Init RX ISR  */
    #if(0u != SPI_IMU_INTERNAL_RX_INT_ENABLED)
    ...
    (void) SPI_IMU_ReadTxStatus(); /* Clear Tx status and swStatusTx */
    (void) SPI_IMU_ReadRxStatus(); /* Clear Rx status and swStatusRx */

    /* Configure TX and RX interrupt mask */
    SPI_IMU_TX_STATUS_MASK_REG = SPI_IMU_TX_INIT_INTERRUPTS_MASK;
    SPI_IMU_RX_STATUS_MASK_REG = SPI_IMU_RX_INIT_INTERRUPTS_MASK;
}


/*******************************************************************************
* Function Name: SPI_IMU_Enable
********************************************************************************
*
* Summary:
...
void SPI_IMU_Enable(void) 
{
    ...
    SPI_IMU_COUNTER_CONTROL_REG |= SPI_IMU_CNTR_ENABLE;
    SPI_IMU_TX_STATUS_ACTL_REG  |= SPI_IMU_INT_ENABLE;
    SPI_IMU_RX_STATUS_ACTL_REG  |= SPI_IMU_INT_ENABLE;
    CyExitCriticalSection(enableInterrupts);

    #if(0u != SPI_IMU_INTERNAL_CLOCK)
        SPI_IMU_IntClock_Enable();
...
*
* Global variables:
*  SPI_IMU_initVar - used to check initial configuration, modified on
*  first function call.
*
* Theory:
...
void SPI_IMU_Stop(void) 
{
    ...
    enableInterrupts = CyEnterCriticalSection();
    SPI_IMU_TX_STATUS_ACTL_REG &= ((uint8) ~SPI_IMU_INT_ENABLE);
    SPI_IMU_RX_STATUS_ACTL_REG &= ((uint8) ~SPI_IMU_INT_ENABLE);
    CyExitCriticalSection(enableInterrupts);

    #if(0u != SPI_IMU_INTERNAL_CLOCK)
        SPI_IMU_IntClock_Disable();
    #endif /* (0u != SPI_IMU_INTERNAL_CLOCK) */
...
/*******************************************************************************
* Function Name: SPI_IMU_EnableTxInt
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: SPI_IMU_EnableRxInt
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: SPI_IMU_DisableTxInt
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: SPI_IMU_DisableRxInt
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: SPI_IMU_SetTxInterruptMode
********************************************************************************
*
* Summary:
...
{
    SPI_IMU_TX_STATUS_MASK_REG = intSrc;
}


/*******************************************************************************
* Function Name: SPI_IMU_SetRxInterruptMode
********************************************************************************
*
* Summary:
*  Configure which status bits trigger an interrupt event.
...
{
    SPI_IMU_RX_STATUS_MASK_REG  = intSrc;
}


/*******************************************************************************
* Function Name: SPI_IMU_ReadTxStatus
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  SPI_IMU_swStatusTx - used to store in software status register,
...
uint8 SPI_IMU_ReadTxStatus(void) 
{
    uint8 tmpStatus;
        ...
        tmpStatus = SPI_IMU_TX_STATUS_REG;
...
/*******************************************************************************
* Function Name: SPI_IMU_ReadRxStatus
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  SPI_IMU_swStatusRx - used to store in software Rx status register,
*  modified every function call - resets to zero.
*
* Theory:
...
uint8 SPI_IMU_ReadRxStatus(void) 
{
    uint8 tmpStatus;
        ...
        tmpStatus = SPI_IMU_RX_STATUS_REG;
...
/*******************************************************************************
* Function Name: SPI_IMU_WriteTxData
********************************************************************************
*
* Summary:
...
void SPI_IMU_WriteTxData(uint8 txData) 
{
        ...
        while(0u == (SPI_IMU_TX_STATUS_REG & SPI_IMU_STS_TX_FIFO_NOT_FULL))
        {
        }
...
/*******************************************************************************
* Function Name: SPI_IMU_ReadRxData
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: SPI_IMU_GetRxBufferSize
********************************************************************************
*
* Summary:
...
uint8 SPI_IMU_GetRxBufferSize(void) 
{
    uint8 size;
        ...
        size = (0u != (SPI_IMU_RX_STATUS_REG & SPI_IMU_STS_RX_FIFO_NOT_EMPTY)) ? 1u : 0u;
...
/*******************************************************************************
* Function Name: SPI_IMU_GetTxBufferSize
********************************************************************************
*
* Summary:
...
uint8  SPI_IMU_GetTxBufferSize(void) 
{
    uint8 size;
        ...
        size = SPI_IMU_TX_STATUS_REG;

        if(0u != (size & SPI_IMU_STS_TX_FIFO_EMPTY))
        {
            size = 0u;
        }
        else if(0u != (size & SPI_IMU_STS_TX_FIFO_NOT_FULL))
        {
            size = 1u;
        }
        else
        {
            size = SPI_IMU_FIFO_SIZE;
        }
...
/*******************************************************************************
* Function Name: SPI_IMU_ClearRxBuffer
********************************************************************************
*
* Summary:
...
void SPI_IMU_ClearRxBuffer(void) 
{
    ...
    while(0u !=(SPI_IMU_RX_STATUS_REG & SPI_IMU_STS_RX_FIFO_NOT_EMPTY))
    {
        (void) CY_GET_REG8(SPI_IMU_RXDATA_PTR);
    }
...
/*******************************************************************************
* Function Name: SPI_IMU_ClearTxBuffer
********************************************************************************
*
* Summary:
...
void SPI_IMU_ClearTxBuffer(void) 
{
    ...
    enableInterrupts = CyEnterCriticalSection();
    /* Clear TX FIFO */
    SPI_IMU_AUX_CONTROL_DP0_REG |= ((uint8)  SPI_IMU_TX_FIFO_CLR);
    SPI_IMU_AUX_CONTROL_DP0_REG &= ((uint8) ~SPI_IMU_TX_FIFO_CLR);
...
/*******************************************************************************
* Function Name: SPI_IMU_PutArray
********************************************************************************
*
* Summary:
                                                                          ...
                                                                          
{
    ...
    while(byteCount > 0u)
    {
        SPI_IMU_WriteTxData(buffer[bufIndex]);
        bufIndex++;
        byteCount--;
    }
}
...
/*******************************************************************************
* Function Name: SPI_IMU_ClearFIFO
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: SPI_IMU_EnableInt
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: SPI_IMU_DisableInt
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: SPI_IMU_SetInterruptMode
********************************************************************************
*
* Summary:
*  Configure which status bits trigger an interrupt event.
...
{
    SPI_IMU_TX_STATUS_MASK_REG  = (intSrc & ((uint8) ~SPI_IMU_STS_SPI_IDLE));
    SPI_IMU_RX_STATUS_MASK_REG  =  intSrc;
}


/*******************************************************************************
* Function Name: SPI_IMU_ReadStatus
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  SPI_IMU_swStatus - used to store in software status register,
*  modified every function call - resets to zero.
*
* Theory:
...
uint8 SPI_IMU_ReadStatus(void) 
{
    ...
    #if(SPI_IMU_TX_SOFTWARE_BUF_ENABLED || SPI_IMU_RX_SOFTWARE_BUF_ENABLED)
    ...
    #endif /* (SPI_IMU_TX_SOFTWARE_BUF_ENABLED || SPI_IMU_RX_SOFTWARE_BUF_ENABLED) */
