...
*/
     ...
     *  @{
     */
        #define CURRENT_SENSE_1_INTR_NONE      (uint16)(0x0000u)
        #define CURRENT_SENSE_1_INTR_RISING    (uint16)(0x0001u)
        #define CURRENT_SENSE_1_INTR_FALLING   (uint16)(0x0002u)
        #define CURRENT_SENSE_1_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */
...
#endif /*  CY_PINS_CURRENT_SENSE_1_H */
