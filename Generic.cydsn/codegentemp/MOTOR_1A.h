...
*/
     ...
     *  @{
     */
        #define MOTOR_1A_INTR_NONE      (uint16)(0x0000u)
        #define MOTOR_1A_INTR_RISING    (uint16)(0x0001u)
        #define MOTOR_1A_INTR_FALLING   (uint16)(0x0002u)
        #define MOTOR_1A_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */
