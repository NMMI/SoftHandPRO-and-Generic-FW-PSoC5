...
#if !(CY_PSOC5A &&\
	 MOTOR_1A__PORT == 15 && ((MOTOR_1A__MASK & 0xC0) != 0))
...
*
* \funcusage
*  \snippet MOTOR_1A_SUT.c usage_MOTOR_1A_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet MOTOR_1A_SUT.c usage_MOTOR_1A_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet MOTOR_1A_SUT.c usage_MOTOR_1A_Read  
*******************************************************************************/
...
* preferred MOTOR_1A_Read() API because the 
* MOTOR_1A_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet MOTOR_1A_SUT.c usage_MOTOR_1A_ReadDataReg 
*******************************************************************************/
