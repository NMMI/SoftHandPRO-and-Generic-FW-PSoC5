...
*
* \funcusage
*  \snippet FTDI_ENABLE_SUT.c usage_FTDI_ENABLE_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet FTDI_ENABLE_SUT.c usage_FTDI_ENABLE_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet FTDI_ENABLE_SUT.c usage_FTDI_ENABLE_Read  
*******************************************************************************/
...
* preferred FTDI_ENABLE_Read() API because the 
* FTDI_ENABLE_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet FTDI_ENABLE_SUT.c usage_FTDI_ENABLE_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: FTDI_ENABLE_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use FTDI_ENABLE_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - FTDI_ENABLE_0_INTR       (First pin in the list)
    *  - FTDI_ENABLE_1_INTR       (Second pin in the list)
    *  - ...
    *  - FTDI_ENABLE_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet FTDI_ENABLE_SUT.c usage_FTDI_ENABLE_SetInterruptMode
    *******************************************************************************/
    void FTDI_ENABLE_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & FTDI_ENABLE_0_INTR) != 0u) 
		{ 
			 FTDI_ENABLE_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet FTDI_ENABLE_SUT.c usage_FTDI_ENABLE_ClearInterrupt
    *******************************************************************************/
