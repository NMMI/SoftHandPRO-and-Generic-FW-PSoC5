...
#if !(CY_PSOC5A &&\
	 MOTOR_EN__PORT == 15 && ((MOTOR_EN__MASK & 0xC0) != 0))
...
*
* \funcusage
*  \snippet MOTOR_EN_SUT.c usage_MOTOR_EN_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet MOTOR_EN_SUT.c usage_MOTOR_EN_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet MOTOR_EN_SUT.c usage_MOTOR_EN_Read  
*******************************************************************************/
...
* preferred MOTOR_EN_Read() API because the 
* MOTOR_EN_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet MOTOR_EN_SUT.c usage_MOTOR_EN_ReadDataReg 
*******************************************************************************/
