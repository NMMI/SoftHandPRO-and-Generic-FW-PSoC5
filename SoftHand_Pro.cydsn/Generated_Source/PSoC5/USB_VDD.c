...
*
* \funcusage
*  \snippet USB_VDD_SUT.c usage_USB_VDD_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet USB_VDD_SUT.c usage_USB_VDD_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet USB_VDD_SUT.c usage_USB_VDD_Read  
*******************************************************************************/
...
* preferred USB_VDD_Read() API because the 
* USB_VDD_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet USB_VDD_SUT.c usage_USB_VDD_ReadDataReg 
*******************************************************************************/
