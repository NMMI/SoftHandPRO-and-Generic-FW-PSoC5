...
*
* \funcusage
*  \snippet MOTOR_2A_SUT.c usage_MOTOR_2A_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet MOTOR_2A_SUT.c usage_MOTOR_2A_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet MOTOR_2A_SUT.c usage_MOTOR_2A_Read  
*******************************************************************************/
...
* preferred MOTOR_2A_Read() API because the 
* MOTOR_2A_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet MOTOR_2A_SUT.c usage_MOTOR_2A_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: MOTOR_2A_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use MOTOR_2A_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - MOTOR_2A_0_INTR       (First pin in the list)
    *  - MOTOR_2A_1_INTR       (Second pin in the list)
    *  - ...
    *  - MOTOR_2A_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet MOTOR_2A_SUT.c usage_MOTOR_2A_SetInterruptMode
    *******************************************************************************/
    void MOTOR_2A_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & MOTOR_2A_0_INTR) != 0u) 
		{ 
			 MOTOR_2A_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet MOTOR_2A_SUT.c usage_MOTOR_2A_ClearInterrupt
    *******************************************************************************/
