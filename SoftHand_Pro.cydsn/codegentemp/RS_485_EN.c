...
*
* \funcusage
*  \snippet RS_485_EN_SUT.c usage_RS_485_EN_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet RS_485_EN_SUT.c usage_RS_485_EN_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet RS_485_EN_SUT.c usage_RS_485_EN_Read  
*******************************************************************************/
...
* preferred RS_485_EN_Read() API because the 
* RS_485_EN_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet RS_485_EN_SUT.c usage_RS_485_EN_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: RS_485_EN_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use RS_485_EN_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - RS_485_EN_0_INTR       (First pin in the list)
    *  - RS_485_EN_1_INTR       (Second pin in the list)
    *  - ...
    *  - RS_485_EN_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet RS_485_EN_SUT.c usage_RS_485_EN_SetInterruptMode
    *******************************************************************************/
    void RS_485_EN_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & RS_485_EN_0_INTR) != 0u) 
		{ 
			 RS_485_EN_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet RS_485_EN_SUT.c usage_RS_485_EN_ClearInterrupt
    *******************************************************************************/
