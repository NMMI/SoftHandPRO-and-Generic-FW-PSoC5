...
module top ;
    ...
    defparam UART_RS485.EnIntTXInterrupt = 1;
	...
	wire [0:0] tmpOE__MOTOR_PORT_net;
	wire [0:0] tmpFB_0__MOTOR_PORT_net;
	wire [0:0] tmpIO_0__MOTOR_PORT_net;
	wire [0:0] tmpINTERRUPT_0__MOTOR_PORT_net;
	electrical [0:0] tmpSIOVREF__MOTOR_PORT_net;

	cy_psoc3_pins_v1_10
		#(.id("11c30cbe-dd54-4133-b9f8-c632e49aa813"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .use_annotation(1'b0))
		MOTOR_PORT
		 (.oe(tmpOE__MOTOR_PORT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MOTOR_PORT_net[0:0]}),
		  .io({tmpIO_0__MOTOR_PORT_net[0:0]}),
		  .siovref(tmpSIOVREF__MOTOR_PORT_net),
		  .interrupt({tmpINTERRUPT_0__MOTOR_PORT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MOTOR_PORT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
