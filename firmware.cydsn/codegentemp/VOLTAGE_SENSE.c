...
#if !(CY_PSOC5A &&\
	 VOLTAGE_SENSE__PORT == 15 && ((VOLTAGE_SENSE__MASK & 0xC0) != 0))
...
*
* \funcusage
*  \snippet VOLTAGE_SENSE_SUT.c usage_VOLTAGE_SENSE_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet VOLTAGE_SENSE_SUT.c usage_VOLTAGE_SENSE_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet VOLTAGE_SENSE_SUT.c usage_VOLTAGE_SENSE_Read  
*******************************************************************************/
...
* preferred VOLTAGE_SENSE_Read() API because the 
* VOLTAGE_SENSE_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet VOLTAGE_SENSE_SUT.c usage_VOLTAGE_SENSE_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: VOLTAGE_SENSE_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use VOLTAGE_SENSE_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - VOLTAGE_SENSE_0_INTR       (First pin in the list)
    *  - VOLTAGE_SENSE_1_INTR       (Second pin in the list)
    *  - ...
    *  - VOLTAGE_SENSE_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet VOLTAGE_SENSE_SUT.c usage_VOLTAGE_SENSE_SetInterruptMode
    *******************************************************************************/
    void VOLTAGE_SENSE_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & VOLTAGE_SENSE_0_INTR) != 0u) 
		{ 
			 VOLTAGE_SENSE_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet VOLTAGE_SENSE_SUT.c usage_VOLTAGE_SENSE_ClearInterrupt
    *******************************************************************************/
