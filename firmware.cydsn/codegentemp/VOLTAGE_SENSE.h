...
*/
     ...
     *  @{
     */
        #define VOLTAGE_SENSE_INTR_NONE      (uint16)(0x0000u)
        #define VOLTAGE_SENSE_INTR_RISING    (uint16)(0x0001u)
        #define VOLTAGE_SENSE_INTR_FALLING   (uint16)(0x0002u)
        #define VOLTAGE_SENSE_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */
