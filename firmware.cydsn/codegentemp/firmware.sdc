...
# Date: Fri, 11 Jan 2019 16:18:32 GMT
#set_units -time ns
...
create_generated_clock -name {CLOCK_PWM} -source [get_pins {ClockBlock/clk_sync}] -edges {1 33 65} [list [get_pins {ClockBlock/dclk_glb_3}]]
